...
def list_of_prices(input)
  input.each do |location, sales|
    sales[:transactions].each do |individual_transaction|
      puts "A house was sold in #{location[0]}, #{location[1]} for #{individual_transaction[0]} on #{individual_transaction[2]}"
    end
    end
end
list_of_prices(house_prices)
